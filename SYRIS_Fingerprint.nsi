...
OutFile "SYRIS_Fingerprint Setup.exe";jash modify
InstallDir "$PROGRAMFILES\SYRIS_Fingerprint";jash modify
...
Section "MainSection" SEC01
  ...
  File "Release\en\SYRIS_Fingerprint.resources.dll";jash modify
  SetOutPath "$INSTDIR\zh-CN"
  File "Release\zh-CN\SYRIS_Fingerprint.resources.dll";jash modify
  SetOutPath "$INSTDIR\zh-TW"
  File "Release\zh-TW\SYRIS_Fingerprint.resources.dll";jash modify
  
  SetOutPath "$INSTDIR"
  CreateDirectory "$SMPROGRAMS\SYRIS_Fingerprint";jash modify
  CreateShortCut "$SMPROGRAMS\SYRIS_Fingerprint\SYRIS_Fingerprint.lnk" "$INSTDIR\SYRIS_Fingerprint.exe";jash modify
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\SYRIS_Fingerprint.exe";jash modify
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\SYRIS_Fingerprint.exe";jash modify
...
Section Uninstall
  ...
  Delete "$DESKTOP\SYRIS_Fingerprint.lnk";jash modify
